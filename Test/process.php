...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($errors) {
        ...
        echo "<div style='font-family: Arial, sans-serif; margin: 20px auto; width: 70%; background-color: #f8f9fa; padding: 20px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2);'>";
            echo "<h2 style='text-align: center; font-size: 2.5rem; color: #333; margin-bottom: 20px;'>Information</h2>";
            ...
            echo "<thead style='background-color:rgb(255, 127, 127); color: white; text-align: center;'>
                    <tr>
